...
const RegisterPage = () => {
  ...
  return (
    ...
    //         </button>
    //         {errors.password && (
    //           <p className="text-xs text-red-500 mt-2 pl-2">{errors.password}</p>
    //         )}
    //       </div>
...
px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
  ...
  flex flex-col lg:flex-row transition-all duration-500">
    ...
    flex flex-col justify-center">
      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="relative">
          <input
            ...
            placeholder="Create a password"
            className="w-full bg-white border border-gray-300 rounded-full 
            px-5 py-2.5 sm:py-3 pr-12 text-sm 
            focus:ring-2 focus:ring-indigo-500 outline-none transition"
          />
          <button
            type="button"
      ...
      <button
        onClick={handleSubmit}
        disabled={isSigningUp}
        className="w-full mt-6 bg-indigo-700 text-white 
    ...
    text-white relative px-10 xl:px-14 py-14 
    flex-col justify-center">
      ...
      <div className="absolute bottom-0 right-6 opacity-10 
      text-[120px] xl:text-[180px] font-bold select-none">
        EDU
      </div>
